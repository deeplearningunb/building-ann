...
transformer = ColumnTransformer(
    transformers=[("OneHot", OneHotEncoder(), [1])], remainder="passthrough"
)
...
classifier.add(
    Dense(units=6, kernel_initializer="uniform", activation="selu", input_dim=11)
)
...
grid_search = GridSearchCV(
    estimator=classifier, scoring="accuracy", param_grid=parameters, cv=10
)
